...
import { ArrowLeft, Bath, Bed, Building2, ChevronLeft, ChevronRight, Eye, Rotate3D, Ruler, Shield, Wifi, Zap } from 'lucide-react';
...
export default function UrbanModern1500Page() {
  ...
  const modelData = {
    name: t('models.urbanModern.name'),
    tagline: t('models.urbanModern.tagline'),
    area: t('models.urbanModern.area'),
    bedrooms: 3,
    bathrooms: 2.5,
    price: t('models.urbanModern.price'),
    pricePerSqFt: t('models.urbanModern.pricePerSqFt'),
    timeline: t('models.urbanModern.timeline'),
    images: [
      "/images/roof-deck/img1.jpg",
      "/images/roof-deck/img2.jpg",
      "/images/roof-deck/img3.jpg",
    ],
    features: [
      { icon: Building2, title: t('models.urbanModern.features.urbanDesign.title'), description: t('models.urbanModern.features.urbanDesign.description') },
      { icon: Wifi, title: t('models.urbanModern.features.smartReady.title'), description: t('models.urbanModern.features.smartReady.description') },
      { icon: Zap, title: t('models.urbanModern.features.cityEfficient.title'), description: t('models.urbanModern.features.cityEfficient.description') },
      { icon: Shield, title: t('models.urbanModern.features.modernSecurity.title'), description: t('models.urbanModern.features.modernSecurity.description') },
    ],
    specifications: {
      [t('models.urbanModern.specifications.totalArea')]: t('models.urbanModern.area'),
      [t('models.urbanModern.specifications.footprint')]: t('models.urbanModern.specifications.footprintValue'),
      [t('models.urbanModern.specifications.bedrooms')]: t('models.urbanModern.specifications.bedroomsValue'),
      [t('models.urbanModern.specifications.bathrooms')]: "2.5",
      [t('models.urbanModern.specifications.parking')]: t('models.urbanModern.specifications.parkingValue'),
      [t('models.urbanModern.specifications.foundation')]: t('models.urbanModern.specifications.foundationValue'),
      [t('models.urbanModern.specifications.exterior')]: t('models.urbanModern.specifications.exteriorValue'),
      [t('models.urbanModern.specifications.roofing')]: t('models.urbanModern.specifications.roofingValue'),
      [t('models.urbanModern.specifications.energyRating')]: t('models.urbanModern.specifications.energyRatingValue')
    },
    floorPlan: [
    ...
    floorPlanLabels: [
      t('models.urbanModern.floorPlanLabels.groundFloor'),
      t('models.urbanModern.floorPlanLabels.terraceLevel')
    ],
    model3D: "/3DModels/3bhk/3BHK Villa and 3d design.obj"
  };
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            {t('models.urbanModern.backToModels')}
          </Link>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                ...
                >
                  ...
                  <div
                    ...
                    style={{ color: '#A0522D' }}
                  >
                    {t('models.urbanModern.stats.totalArea')}
                  </div>
                </div>
                <div
                  className="text-center p-4 rounded-lg shadow-sm border"
                ...
                >
                  ...
                  <div
                    ...
                    style={{ color: '#A0522D' }}
                  >
                    {t('models.urbanModern.stats.bedrooms')}
                  </div>
                </div>
                <div
                  className="text-center p-4 rounded-lg shadow-sm border"
                ...
                >
                  ...
                  <div
                    ...
                    style={{ color: '#A0522D' }}
                  >
                    {t('models.urbanModern.stats.bathrooms')}
                  </div>
                </div>
                <div
                  className="text-center p-4 rounded-lg shadow-sm border"
                ...
                >
                  ...
                  <div
                    ...
                    style={{ color: '#A0522D' }}
                  >
                    {t('models.urbanModern.stats.startingPrice')}
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          <Tabs defaultValue="overview" className="w-full">
            ...
            >
              <TabsTrigger
                ...
                style={{ color: '#8B4513' }}
              >
                {t('models.urbanModern.tabs.overview')}
              </TabsTrigger>
              <TabsTrigger
                value="features"
                className="transition-all duration-300"
                style={{ color: '#8B4513' }}
              >
                {t('models.urbanModern.tabs.features')}
              </TabsTrigger>
              <TabsTrigger
                value="floorplan"
                className="transition-all duration-300"
                style={{ color: '#8B4513' }}
              >
                {t('models.urbanModern.tabs.floorPlan')}
              </TabsTrigger>
              <TabsTrigger
                value="3d-model"
                className="transition-all duration-300"
                style={{ color: '#8B4513' }}
              >
                {t('models.urbanModern.tabs.model3D')}
              </TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="overview">
              <div className="grid lg:grid-cols-3 gap-8">
                  ...
                  >
                    <CardHeader>
                      <CardTitle style={{ color: '#3C2414' }}>
                        {t('models.urbanModern.overview.title')}
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p
                        ...
                        style={{ color: '#A0522D' }}
                      >
                        {t('models.urbanModern.overview.paragraph1')}
                      </p>
                      <p
                        className="mb-4"
                        style={{ color: '#A0522D' }}
                      >
                        {t('models.urbanModern.overview.paragraph2')}
                      </p>
                      <p style={{ color: '#A0522D' }}>
                        {t('models.urbanModern.overview.paragraph3')}
                      </p>
                    </CardContent>
                  </Card>
                </div>
                ...
                <div>
                  ...
                  >
                    <CardHeader>
                      <CardTitle style={{ color: '#3C2414' }}>{t('models.urbanModern.specificationsTitle')}</CardTitle>
                    </CardHeader>
                    <CardContent>
                ...
                <CardHeader>
                  ...
                  >
                    <Eye
                      ...
                      style={{ color: '#FDB515' }}
                    />
                    {t('models.urbanModern.floorPlan.title')}
                  </CardTitle>
                  <p style={{ color: '#A0522D' }}>
                    {t('models.urbanModern.floorPlan.description')}
                  </p>
                </CardHeader>
                <CardContent>
                  <div className="relative">
                    ...
                    >
                      <ImageWithFallback
                        ...
                        alt={`${modelData.floorPlanLabels[activeFloorPlan]} ${t('models.urbanModern.floorPlan.planSuffix')}`}
                ...
                <CardHeader>
                  ...
                  >
                    <Rotate3D
                      ...
                      style={{ color: '#FDB515' }}
                    />
                    {t('models.urbanModern.model3D.title')}
                  </CardTitle>
                  <p style={{ color: '#A0522D' }}>
                    {t('models.urbanModern.model3D.description')}
                  </p>
                </CardHeader>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl mb-6 font-bold">
              {t('models.urbanModern.cta.title')}
            </h2>
            <p
              className="text-xl mb-8"
              style={{ color: 'rgba(255, 255, 255, 0.9)' }}
            >
              {t('models.urbanModern.cta.description')}
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                ...
                onClick={openPopup}
              >
                {t('models.urbanModern.cta.getStarted')}
              </Button>
              <Link href="/price-analysis">
                ...
                >
                  {t('models.urbanModern.cta.compareCosts')}
                </Button>
              </Link>
            </div>
          </motion.div>
