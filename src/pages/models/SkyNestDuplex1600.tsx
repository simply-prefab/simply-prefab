...
import { ArrowLeft, Bath, Bed, Car, ChevronLeft, ChevronRight, Eye, Home, Leaf, Rotate3D, Ruler, Shield, Zap } from 'lucide-react';
...
export default function GreenVilla1800Page() {
  ...
  const modelData = {
    name: t('models.greenVilla.name'),
    tagline: t('models.greenVilla.tagline'),
    area: t('models.greenVilla.area'),
    bedrooms: 4,
    bathrooms: 2,
    price: t('models.greenVilla.price'),
    pricePerSqFt: t('models.greenVilla.pricePerSqFt'),
    images: [
      "/images/models/duplex1.jpg",
      "/images/models/duplex2.jpg"
    ],
    features: [
      { icon: Home, title: t('models.greenVilla.features.openFloorPlan.title'), description: t('models.greenVilla.features.openFloorPlan.description') },
      { icon: Zap, title: t('models.greenVilla.features.smartHome.title'), description: t('models.greenVilla.features.smartHome.description') },
      { icon: Leaf, title: t('models.greenVilla.features.sustainable.title'), description: t('models.greenVilla.features.sustainable.description') },
      { icon: Car, title: t('models.greenVilla.features.garage.title'), description: t('models.greenVilla.features.garage.description') },
      { icon: Shield, title: t('models.greenVilla.features.weatherResistant.title'), description: t('models.greenVilla.features.weatherResistant.description') },
      { icon: Ruler, title: t('models.greenVilla.features.flexibleLayout.title'), description: t('models.greenVilla.features.flexibleLayout.description') }
    ],
    specifications: {
      [t('models.greenVilla.specifications.totalArea')]: t('models.greenVilla.area'),
      [t('models.greenVilla.specifications.lotSize')]: t('models.greenVilla.specifications.lotSizeValue'),
      [t('models.greenVilla.specifications.bedrooms')]: "4",
      [t('models.greenVilla.specifications.bathrooms')]: "2",
      [t('models.greenVilla.specifications.garage')]: t('models.greenVilla.specifications.garageValue'),
      [t('models.greenVilla.specifications.foundation')]: t('models.greenVilla.specifications.foundationValue'),
      [t('models.greenVilla.specifications.exterior')]: t('models.greenVilla.specifications.exteriorValue'),
      [t('models.greenVilla.specifications.roofing')]: t('models.greenVilla.specifications.roofingValue'),
      [t('models.greenVilla.specifications.energyRating')]: t('models.greenVilla.specifications.energyRatingValue')
    },
    floorPlan: [
      "/3DModels/3bhk/Level-1.PNG",
      "/3DModels/3bhk/Level-2.PNG"
    ],
    floorPlanLabels: [
      t('models.greenVilla.floorPlanLabels.groundFloor'),
      t('models.greenVilla.floorPlanLabels.firstFloor')
    ],
    model3D: "/3DModels/4bhk/4BHK Villa and 3d design.obj"
  };
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            {t('models.greenVilla.backToModels')}
          </Link>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                ...
                >
                  ...
                  <div
                    ...
                    style={{ color: '#A0522D' }}
                  >
                    {t('models.greenVilla.stats.totalArea')}
                  </div>
                </div>
                <div
                  className="text-center p-4 rounded-lg shadow-sm border"
                ...
                >
                  ...
                  <div
                    ...
                    style={{ color: '#A0522D' }}
                  >
                    {t('models.greenVilla.stats.bedrooms')}
                  </div>
                </div>
                <div
                  className="text-center p-4 rounded-lg shadow-sm border"
                ...
                >
                  ...
                  <div
                    ...
                    style={{ color: '#A0522D' }}
                  >
                    {t('models.greenVilla.stats.bathrooms')}
                  </div>
                </div>
                <div
                  className="text-center p-4 rounded-lg shadow-sm border"
                ...
                >
                  ...
                  <div
                    ...
                    style={{ color: '#A0522D' }}
                  >
                    {t('models.greenVilla.stats.startingPrice')}
                  </div>
                </div>
              </div>
          ...
          <Tabs defaultValue="overview" className="w-full">
            ...
            >
              <TabsTrigger
                ...
                style={{ color: '#8B4513' }}
              >
                {t('models.greenVilla.tabs.overview')}
              </TabsTrigger>
              <TabsTrigger
                value="features"
                className="transition-all duration-300"
                style={{ color: '#8B4513' }}
              >
                {t('models.greenVilla.tabs.features')}
              </TabsTrigger>
              <TabsTrigger
                value="floorplan"
                className="transition-all duration-300"
                style={{ color: '#8B4513' }}
              >
                {t('models.greenVilla.tabs.floorPlan')}
              </TabsTrigger>
              <TabsTrigger
                value="3d-model"
                className="transition-all duration-300"
                style={{ color: '#8B4513' }}
              >
                {t('models.greenVilla.tabs.model3D')}
              </TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="overview">
              <div className="grid lg:grid-cols-3 gap-8">
                  ...
                  >
                    <CardHeader>
                      <CardTitle style={{ color: '#3C2414' }}>
                        {t('models.greenVilla.overview.title')}
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p
                        ...
                        style={{ color: '#A0522D' }}
                      >
                        {t('models.greenVilla.overview.paragraph1')}
                      </p>
                      <p
                        className="mb-4"
                        style={{ color: '#A0522D' }}
                      >
                        {t('models.greenVilla.overview.paragraph2')}
                      </p>
                      <p style={{ color: '#A0522D' }}>
                        {t('models.greenVilla.overview.paragraph3')}
                      </p>
                    </CardContent>
                  </Card>
                </div>
                ...
                <div>
                  ...
                  >
                    <CardHeader>
                      <CardTitle style={{ color: '#3C2414' }}>{t('models.greenVilla.specificationsTitle')}</CardTitle>
                    </CardHeader>
                    <CardContent>
                ...
                <CardHeader>
                  ...
                  >
                    <Eye
                      ...
                      style={{ color: '#FDB515' }}
                    />
                    {t('models.greenVilla.floorPlan.title')}
                  </CardTitle>
                  <p style={{ color: '#A0522D' }}>
                    {t('models.greenVilla.floorPlan.description')}
                  </p>
                </CardHeader>
                <CardContent>
                  <div className="relative">
                    ...
                    >
                      <ImageWithFallback
                        ...
                        alt={`${modelData.floorPlanLabels[activeFloorPlan]} ${t('models.greenVilla.floorPlan.planSuffix')}`}
                ...
                <CardHeader>
                  ...
                  >
                    <Rotate3D
                      ...
                      style={{ color: '#FDB515' }}
                    />
                    {t('models.greenVilla.model3D.title')}
                  </CardTitle>
                  <p style={{ color: '#A0522D' }}>
                    {t('models.greenVilla.model3D.description')}
                  </p>
                </CardHeader>
                <CardContent>
                  <div
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl mb-6 font-bold">
              {t('models.greenVilla.cta.title')}
            </h2>
            <p
              className="text-xl mb-8"
              style={{ color: 'rgba(255, 255, 255, 0.9)' }}
            >
              {t('models.greenVilla.cta.description')}
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                ...
                onClick={openPopup}
              >
                {t('models.greenVilla.cta.getStarted')}
              </Button>
              <Link href="/price-analysis">
                ...
                >
                  {t('models.greenVilla.cta.compareCosts')}
                </Button>
              </Link>
            </div>
          </motion.div>
